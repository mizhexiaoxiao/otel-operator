...
//+kubebuilder:webhook:path=/mutate-otel-mzx-org-v1-opentelemetrycollector,mutating=true,failurePolicy=fail,sideEffects=None,groups=otel.mzx.org,resources=opentelemetrycollectors,verbs=create;update,versions=v1,name=mopentelemetrycollector.kb.io,admissionReviewVersions=v1
...
//+kubebuilder:webhook:path=/validate-otel-mzx-org-v1-opentelemetrycollector,mutating=false,failurePolicy=fail,sideEffects=None,groups=otel.mzx.org,resources=opentelemetrycollectors,verbs=create;update,versions=v1,name=vopentelemetrycollector.kb.io,admissionReviewVersions=v1
